...
public class Main {
    public static void main(String[] args) {
        ...
        Toy t1 = new Toy(123,"khilona",1234.00,"funnatics",12,18,YearMonth.of(2023,12));
        Toy t2 = new Toy(124,"Mhilona",34.00,"Education",5,10,YearMonth.of(2022,12));
        Toy t3 = new Toy(125,"Shilona",234.00,"sports",12,18,YearMonth.of(2023,10));
...
//    1. List the Stock
        System.out.println("List of Stock: "+stk.listStock());
//    2. Filter the stock by category [e.g. Educational / Battery operated etc]
        System.out.println("Stocks by category: "+stk.filterByCategory2("sports"));
//    3. List Toys by price range (e.g. between 500 to 1000)
        System.out.println("Toys by price range"+stk.filterByPrice2(25,300));
//    4. Sort the toys by price-category wise
        System.out.println("Toys sorted price-category wise"+stk.sortByPriceCat2());
//    5. Make the list of old stock [older than 1 year]
        System.out.println("List of old stock [older than 1 year]: "+stk.filterByPurchase2(1));
//    6. Make a group of toys as per their category, count them
        System.out.println("Group of toys as per their category, and their counting: "+stk.groupByCatCount());
//    7. Display the most expensive/least expensive toy in given category
        System.out.println(" Most expensive toy in given category"+stk.getMostExpToy("sports"));
//    8. Print total no of toys in stock for each age grp
        System.out.println("Total no of toys in stock for each age grp:"+stk.grpCountToysAge());
