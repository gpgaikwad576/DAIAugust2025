...
public  abstract class Account {
    ...
    public static Tuple transaction(long withaccno, long depaccno, double amount) throws CustomException{
        ...
        Response rp = new Response(false,"Exception occurred");
        ...
        if(rp.isSuccessful){
            throw new CustomException("Both withdraw and deposit happened successfully");
        }
